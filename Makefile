...
README := ReadMe,fff
LIBRARIES := Config.bbt Date.bbt Icon.bbt LegacyWimp.bbt Legacy3D.bbt Resources.bbt String.bbt Url.bbt WimpError.bbt WimpLib.bbt WimpSprite.bbt Window.bbt
